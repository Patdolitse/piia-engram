...
_WRITE_TOOLS = [
    ...
    ("review_knowledge", {"knowledge_id": "fake-id"}),
    ("merge_knowledge", {"primary_id": "a", "secondary_id": "b"}),
    ("link_knowledge", {"id_a": "a", "id_b": "b"}),
    ("unlink_knowledge", {"id_a": "a", "id_b": "b"}),
    ("update_playbook", {"playbook_id": "fake-id", "status": "active"}),
    ("archive_playbook", {"playbook_id": "fake-id"}),
    ...
    ("update_execution_step", {"playbook_id": "fake-id", "step_order": 1, "status": "completed"}),
