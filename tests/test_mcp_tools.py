...
# ---------------------------------------------------------------------------
# read_web_content is covered by tests/test_reader.py (Round 4): the sidecar
# adapter, built-in reader, three-layer routing, and MCP str/length contract.
# The old urllib mock tests moved there (sidecar adapter layer) so they no
# longer bind to read_web_content's implementation detail.
# ---------------------------------------------------------------------------
