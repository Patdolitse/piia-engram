...
|---|---|
| Version frame | **v4.6.0** (verified 2026-06-18; check PyPI and GitHub Releases for the latest published package) |
...
| Tests passing | **3637** (unit + integration; 3 skipped, 3640 collected) |
