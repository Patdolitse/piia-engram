...
|---|---|
| Version frame | **v4.6.1** (verified 2026-06-19; check PyPI and GitHub Releases for the latest published package) |
...
| Tests passing | **3654** (unit + integration; 3 skipped, 3657 collected) |
