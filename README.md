...
|---|---|
| Version frame | **v4.5.0** (verified 2026-06-18; check PyPI and GitHub Releases for the latest published package) |
...
| Tests passing | **3603** (unit + integration; 3 skipped, 3606 collected) |
